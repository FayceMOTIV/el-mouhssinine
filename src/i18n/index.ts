...
export const translations = {
  fr: {
    ...
    siretInvalid: 'Le SIRET doit contenir exactement 14 chiffres',
    legalRepRequired: 'Le représentant légal est requis',
    ...
    verificationEmailSent: 'Un email de vérification a été envoyé. Pensez à vérifier vos spams.',
    ...
    membershipImpossible: 'Adhésion impossible',
    mustReadRules: 'Lecture obligatoire',
    mustReadRulesMsg:
      'Veuillez lire le règlement intérieur avant de continuer.',
    mustAcceptRules: 'Acceptation requise',
    mustAcceptRulesMsg:
      'Veuillez accepter le règlement intérieur pour continuer.',
    ...
    audioError: 'Impossible de charger le fichier audio.',
    lessonComplete: 'Leçon terminée !',
    lessonCompleteMsg: 'Félicitations, vous avez terminé cette leçon !',
    ...
    donationThankYou: 'Merci pour votre généreux don !',
    jazakAllahKhayran: 'Jazak Allah Khayran',
    donationConfirmedAmount: 'Votre don de {amount}€ a été confirmé',
    makeAnotherDonation: 'Faire un autre don',
    donationReceiptNote: 'Un reçu fiscal vous sera envoyé automatiquement en début d\'année prochaine',
    bankTransferTitle: 'Virement bancaire',
    taxReceiptNote:
      'Indiquez votre email en référence. Reçu fiscal envoyé automatiquement en janvier',
    donationOf: 'Don de',
    cardPayment: 'CB',
    visaMastercard: 'Visa, Mastercard, CB',
    fastSecurePayment: 'Paiement rapide et sécurisé',
    securePayment:
      'Paiement sécurisé par Stripe • Reçu fiscal annuel automatique',
    cashPayment: 'Espèces',
    ...
    tapToCheck: 'Appuyez sur chaque carte pour vérifier',
    tapToReveal: 'Appuyez',
    ...
    donationRedirectNotice: 'Pour faire un don, vous serez redirigé vers notre site sécurisé.',
    donateOnWebsite: 'Faire un don sur le site',
    ...
    // Member Card (textes pour la carte de membre)
    memberCardActive: 'ACTIF',
    memberCardExpired: 'EXPIRÉ',
    memberCardExpiring: 'EXPIRE BIENTÔT',
    memberCardInactive: 'INACTIF',
    memberCardPendingValidation: 'EN ATTENTE VALIDATION',
    memberCardPendingSignature: 'EN ATTENTE SIGNATURE',
    memberCardPendingPayment: 'EN ATTENTE PAIEMENT',
    memberCardSympathisant: 'SYMPATHISANT',
    memberCardNumber: 'N° ADHÉRENT',
    memberCardNumberFull: 'N° MEMBRE',
    memberCardHolder: 'TITULAIRE',
    memberCardValid: 'VALIDE',
    memberCardValidity: 'VALIDITÉ',
    memberCardCenter: 'Centre Islamique',
    memberCardCity: 'Bourg-en-Bresse',
    memberCardPaid: 'PAYÉ',
    memberCardPending: 'EN ATTENTE',
    memberCardUnpaid: 'NON PAYÉ',
    memberCardMonthly: 'MENSUEL',
    memberCardAnnual: 'ANNUEL',
    memberCardNoMember: 'Aucun membre',
    memberCardSwipeHint: 'Swipez pour voir les autres membres',
  ...
  ar: {
    ...
    lastNameMin: 'يجب أن يحتوي اسم العائلة على حرفين على الأقل',
    companyNameRequired: 'اسم الشركة مطلوب',
    siretInvalid: 'يجب أن يحتوي رقم SIRET على 14 رقماً بالضبط',
    legalRepRequired: 'الممثل القانوني مطلوب',
    addressRequired: 'العنوان مطلوب',
    postalCodeInvalid: 'يجب أن يحتوي الرمز البريدي على 5 أرقام',
    cityRequired: 'المدينة مطلوبة',
    selectGender: 'يرجى اختيار الجنس',
    enterBirthdate: 'يرجى إدخال تاريخ الميلاد',
    thanksForRegistration: 'شكراً لتسجيلك!',
    emailSent: 'تم إرسال البريد الإلكتروني',
    verificationEmailSent: 'تم إرسال بريد التحقق. تحقق من مجلد الرسائل غير المرغوب فيها.',
    ...
    messageEmpty: 'يرجى كتابة رسالة.',
    subjectRequired: 'الموضوع مطلوب.',
    membershipImpossible: 'العضوية غير ممكنة',
    mustReadRules: 'القراءة إلزامية',
    mustReadRulesMsg: 'يرجى قراءة النظام الداخلي قبل المتابعة.',
    mustAcceptRules: 'القبول مطلوب',
    mustAcceptRulesMsg: 'يرجى قبول النظام الداخلي للمتابعة.',
    ...
    cancelSubscriptionConfirm: 'هل أنت متأكد من إلغاء اشتراكك؟',
    subscriptionCancelled: 'تم إلغاء الاشتراك',
    congratulations: 'تهانينا!',
    audioError: 'تعذر تحميل الملف الصوتي.',
    lessonComplete: 'انتهت الدرس!',
    lessonCompleteMsg: 'تهانينا، لقد أكملت هذا الدرس!',
    ...
    donationThankYou: 'شكراً لتبرعك الكريم!',
    jazakAllahKhayran: 'جزاك الله خيرا',
    donationConfirmedAmount: 'تم تأكيد تبرعكم بمبلغ {amount}€',
    makeAnotherDonation: 'تقديم تبرع آخر',
    donationReceiptNote: 'سيتم إرسال إيصال ضريبي تلقائياً في بداية السنة القادمة',
    bankTransferTitle: 'تحويل بنكي',
    taxReceiptNote: 'أدخل بريدك الإلكتروني كمرجع. إيصال ضريبي يُرسل تلقائياً في يناير',
    donationOf: 'تبرع بمبلغ',
    cardPayment: 'بطاقة بنكية',
    visaMastercard: 'فيزا، ماستركارد',
    fastSecurePayment: 'دفع سريع وآمن',
    securePayment: 'دفع آمن عبر Stripe • إيصال ضريبي سنوي تلقائي',
    cashPayment: 'نقداً',
    ...
    nextStep: '← التالي',
    finishLesson: 'إنهاء',
    tapToCheck: 'اضغط على كل بطاقة للتحقق',
    tapToReveal: 'اضغط',
    allRevealed: 'تم الكشف عن الكل!',
    exampleTitle: 'مثال',
    ...
    donationRedirectNotice: 'للتبرع، ستتم إعادة توجيهك إلى موقعنا الآمن.',
    donateOnWebsite: 'تبرع على الموقع',
    ...
    // Member Card (textes pour la carte de membre)
    memberCardActive: 'نشط',
    memberCardExpired: 'منتهي',
    memberCardExpiring: 'ينتهي قريباً',
    memberCardInactive: 'غير نشط',
    memberCardPendingValidation: 'في انتظار التحقق',
    memberCardPendingSignature: 'في انتظار التوقيع',
    memberCardPendingPayment: 'في انتظار الدفع',
    memberCardSympathisant: 'متعاطف',
    memberCardNumber: 'رقم العضو',
    memberCardNumberFull: 'رقم العضو',
    memberCardHolder: 'المالك',
    memberCardValid: 'صالح حتى',
    memberCardValidity: 'الصلاحية',
    memberCardCenter: 'المركز الإسلامي',
    memberCardCity: 'بورغ أون بريس',
    memberCardPaid: 'مدفوع',
    memberCardPending: 'قيد الانتظار',
    memberCardUnpaid: 'غير مدفوع',
    memberCardMonthly: 'شهري',
    memberCardAnnual: 'سنوي',
    memberCardNoMember: 'لا يوجد عضو',
    memberCardSwipeHint: 'اسحب لرؤية الأعضاء الآخرين',
