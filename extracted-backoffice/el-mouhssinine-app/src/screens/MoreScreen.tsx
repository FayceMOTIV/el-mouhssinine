      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>🧭 Direction de la Qibla</Text>
          ...
          {/* Notifications */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>🔔 Notifications de prière</Text>
            <View style={styles.card}>
              {/* Toggle principal */}
                ...
                <>
                  ...
                  <View style={styles.settingRow}>
                    <View style={styles.settingLeft}>
                      ...
                      <Text style={styles.settingLabel}>Rappel avant la prière</Text>
                    </View>
                  ...
                  <View style={styles.settingRow}>
                    <View style={styles.settingLeft}>
                      <Text style={styles.settingIcon}>🔊</Text>
                      <Text style={styles.settingLabel}>Son de l'Adhan</Text>
                    </View>
                    <Switch
                  ...
                  <View style={[styles.settingRow, styles.settingRowLast]}>
                    <View style={styles.settingLeft}>
                      <Text style={styles.settingIcon}>🕌</Text>
                      <Text style={styles.settingLabel}>Rappel Jumu'a (vendredi)</Text>
                    </View>
                    <Switch
